                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            ...
                            @if($errors->has('name'))
                                ...
                                <strong style="color: #1d2124">{{$errors->first('name')}}</strong>
                            </span>
                            @endif
                        </div>
                    </div>
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            ...
                            @if($errors->has('last_name'))
                                <span class="invalid-feedback" role="alert">
                                <strong style="color: #1d2124">{{$errors->first('last_name')}}</strong>
                            </span>
                            @endif
                        </div>
                    </div>
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            ...
                            @if($errors->has('phone_number'))
                                <span class="invalid-feedback" role="alert">
                                <strong style="color: #1d2124">{{$errors->first('phone_number')}}</strong>
                            </span>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            ...
                            @if($errors->has('password_confirmation'))
                                <span class="invalid-feedback" role="alert">
                                <strong style="color: #1d2124">{{$errors->first('password_confirmation')}}</strong>
                            </span>
                            @endif
                        </div>
                    </div>
